...
public class Validator {
	...
	public static void main(String[] args) {
        ...
        //Validator.class.getProtectionDomain().getCodeSource().getLocation().getPath() being used in last version gives path to the binary (in bin folder) 
        // rather than the working directory, which is what we should be looking for. Hence changed.
        //Also, UnsupportedEncodingException cannot be generated by the code below hence removing try-catch block
